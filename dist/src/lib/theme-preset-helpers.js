 ...
 */
function createButtonFromPreset(prisma, button) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!button)
            return null;
...
function createThemeFromPreset(prisma, pageId, preset, title) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const button = yield createButtonFromPreset(prisma, preset.button);
...
function themeToFrontendFormat(theme) {
    ...
    if (theme.button && theme.button.properties) {
        result.button = Object.assign({ type: theme.button.style, className: theme.button.className || undefined }, theme.button.properties);
    }
    // Outros campos JSON
    if (theme.typeface)
