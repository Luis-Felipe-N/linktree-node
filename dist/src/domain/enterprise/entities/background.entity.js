...
class Background extends entity_1.Entity {
    ...
    static create(props, id) {
        ...
        const background = new Background(Object.assign(Object.assign({}, props), { active: (_a = props.active) !== null && _a !== void 0 ? _a : true, created_at: (_b = props.created_at) !== null && _b !== void 0 ? _b : new Date() }), id);
        return background;
    }
}
