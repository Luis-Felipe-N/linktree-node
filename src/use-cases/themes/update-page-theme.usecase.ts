...
import { makeBackground } from '../makers/make-background'
import { makeButton } from '../makers/make-button'
import type { Background, BackgroundProps } from '@/domain/enterprise/entities/background.entity'
import type { Button, ButtonProps } from '@/domain/enterprise/entities/button.entity'
